...
typedef axtp_status_t (*axtp_stream_handler_fn)(const axtp_rpc_context_t* context, const axtp_stream_payload_t* stream, void* user_data);

typedef enum {
  AXTP_BROKER_TASK_RPC_REQUEST = 1,
  AXTP_BROKER_TASK_RPC_EVENT = 2,
  AXTP_BROKER_TASK_STREAM_DATA = 3
